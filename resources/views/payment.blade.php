    ...
    <section class="bg-darkGrey relative py-[70px]">
        <div class="container">
            ...
            <div class="flex items-center gap-5 lg:justify-between">
                ...
                <form action="{{ route('front.payment.update', $booking->id) }}" method="POST"
                    ...
                    <div class="flex flex-col gap-[30px]">
                        <div class="flex flex-col gap-4">
                            ...
                            @if ($booking->with_driver == 'Yes with driver')
                                <div class="flex items-center justify-between">
                                    <p class="text-base font-normal">
                                        Driver Price
                                    </p>
                                    <p class="text-base font-semibold">
                                        {{ number_format($driver_price) }} per day
                                    </p>
                                </div>
                            @endif
                            ...
                            <div class="flex items-center justify-between">
                                <p class="text-base font-normal">
                                 ...
                                 <p class="text-base font-semibold">
                                    Rp {{ number_format($booking->total_price - ($booking->total_price / (1 + 0.11))) }}
                                </p>
                            </div>
                            <!-- Items -->
                            <div class="flex items-center justify-between">
                ...
                <img src="{{ Storage::url($booking->item->thumbnail_photos) }}"
