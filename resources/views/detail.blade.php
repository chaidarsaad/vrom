<x-front-layout>
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-[29px]">
                ...
                @foreach ($similarItems as $similiarItem)
                    ...
                    <div class="card-popular" data-aos="fade-up" data-aos-delay="{{ $incrementCars += 100 }}">
                        ...
                        <img src="{{ Storage::url($similiarItem->thumbnail_photos) }}"
                            class="rounded-[18px] min-w-[216px] w-full h-full" alt="">
                        <div class="flex items-center justify-between gap-1">
                            <!-- Price -->
                            <p class="text-sm font-normal text-secondary">
                                <span class="text-base font-bold text-primary">Rp
                                    {{ number_format($similiarItem->price) }}</span>/day
                            </p>
                            <!-- Rating -->
                            {{-- <p class="text-dark text-xs font-semibold flex items-center gap-[2px]">
                                ({{ $similiarItem->star }}/{{ $similiarItem->review }})
    ...
    <section class="container relative py-[100px]">
        <header class="text-center mb-[50px]" data-aos="fade-up">
            <h2 class="font-bold text-dark text-[26px] mb-1">
