    ...
    <section class="bg-darkGrey relative py-[70px]">
        <div class="container">
            ...
            <div class="flex items-center gap-5 lg:justify-between">
                    ...
                    <div class="grid grid-cols-2 items-center gap-y-6 gap-x-4 lg:gap-x-[30px]">
                        ...
                        <div class="flex flex-col col-span-2 gap-3">
                            ...
                            <input type="number" name="number_phone" id="number_phone" required
                                ...
                                value="{{ old('number_phone') ?? Auth::user()->phone }}">
                        </div>
                        ...
                        <!-- group with driver and with delivery -->
                        <div class="col-span-2 grid grid-cols-2 gap-y-6 gap-x-4 lg:gap-x-[30px] relative">
                            <!-- With Driver -->
                            @if ($item->type->name == 'Microbus')
                                <div class="flex flex-col col-span-1 gap-3">
                                    <label for="" class="text-base font-semibold text-dark">
                                        With Delivery?
                                    </label>
                                    <select
                                        class="text-base font-medium focus:border-primary focus:outline-none placeholder:text-secondary placeholder:font-normal px-[26px] py-4 border border-grey rounded-[50px] focus:before:appearance-none focus:before:!content-none"
                                        name="with_delivery" required>
                                        {{-- <option value="">Select Option</option> --}}
                                        {{-- <option value="Tidak">No</option> --}}
                                        <option value="Yes with delivery">Yes with delivery</option>
                                    </select>
                                </div>
                            @else
                                <div class="flex flex-col col-span-1 gap-3">
                            ...
                            @if ($item->type->name == 'Microbus')
                                <div class="flex flex-col col-span-1 gap-3">
                                    ...
                                    <select
                                        ...
                                        {{-- <option value="">Select Option</option> --}}
                                        <option value="Yes with driver">Yes with driver</option>
                                    </select>
                                </div>
                            @else
                                <div class="flex flex-col col-span-1 gap-3">
                        ...
                        @else
                            <div id="cityInput" class="flex flex-col col-span-2 gap-3" style="display: none">
                                <label for="" class="text-base font-semibold text-dark">
                                    City
                                </label>
                                <input type="text" name="city" id="city"
                        ...
                        @if ($item->type->name == 'Microbus')
                            <div class="flex flex-col col-span-2 gap-3">
                                ...
                                <input type="text" name="address" id="address"
                                    class="text-base font-medium focus:border-primary focus:outline-none placeholder:text-secondary placeholder:font-normal px-[26px] py-4 border border-grey rounded-[50px]"
                                    placeholder="Where should we deliver your car?" required>
                            </div>
                        @else
                            <div id="alamatInput" class="flex flex-col col-span-2 gap-3" style="display: none">
                                <label for="" class="text-base font-semibold text-dark">
                                    Delivery Address
                                </label>
                                <input type="text" name="address" id="address"
                ...
                <img src="{{ Storage::url($item->thumbnail_photos) }}" class="max-w-[50%] hidden lg:block -mr-[200px]"
                    alt="">
            </div>
        </div>
    </section>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            deliverySelect.addEventListener("change", function() {
                ...
                // Sembunyikan input alamat terlebih dahulu
                alamatInput.style.display = "none";
                cityInput.style.display = "none";

                // Tampilkan input alamat jika driver dipilih
                if (selectedDelivery === "Yes with delivery") {
                    alamatInput.style.display = "";
