    ...
    <section class="bg-darkGrey">
        <div class="container relative py-[100px]">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-4 gap-[29px]">
                @php $incrementBrands = 0 @endphp
                @foreach ($brands as $item)
                    <!-- Card -->
                    <div class="card-popular" data-aos="fade-up" data-aos-delay="{{ $incrementBrands += 100 }}">
                        <div>
                            <h5 class="text-lg text-dark font-bold mb-[2px]">
                                {{ $item->name }}
                            </h5>
                            {{-- <p class="text-sm font-normal text-secondary">dsa
                            </p> --}}
                            <a href="{{ route('front.catalog.detail', $item->slug) }}" class="absolute inset-0"></a>
                        </div>
                        {{-- <img src="" class="rounded-[18px] min-w-[216px] w-full h-[130px]" alt=""> --}}
